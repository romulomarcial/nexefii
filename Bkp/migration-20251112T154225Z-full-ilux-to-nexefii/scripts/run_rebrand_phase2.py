...
for p, original_text in candidates:
    ...
    # Replace getItem('nexefii_lang') -> (localStorage.getItem('nexefii_lang') || (localStorage.getItem('nexefii_lang') || localStorage.getItem('nexefii_lang')))
    new_text = re.sub(r"localStorage\.getItem\(\s*['\"]nexefii_lang['\"]\s*\)",
                      "(localStorage.getItem('nexefii_lang') || (localStorage.getItem('nexefii_lang') || localStorage.getItem('nexefii_lang')))",
                      new_text)
    ...
    def rep_set_lang(m):
        ...
        return "try{ localStorage.setItem('nexefii_lang'," + args + "); }catch(e){} try{ try{ localStorage.setItem('nexefii_lang'," + args + "); }catch(e){} try{ localStorage.setItem('nexefii_lang'," + args + "); }catch(e){}; }catch(e){}"
