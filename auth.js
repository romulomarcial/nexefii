...
if (typeof window.__NEXEFII_AUTH_COMPAT__ === 'undefined') {
  ...
  window.NexefiiAuth = window.NexefiiAuth || {};
  window.NexefiiAuth.isAuthenticated = window.NexefiiAuth.isAuthenticated || window.NexefiiAuth.isAuthenticated;
  window.NexefiiAuth.getCurrentSession = window.NexefiiAuth.getCurrentSession || window.NexefiiAuth.getCurrentSession;
  window.NexefiiAuth.getSession = window.NexefiiAuth.getSession || window.NexefiiAuth.getCurrentSession;
  window.NexefiiAuth.setSession = window.NexefiiAuth.setSession || window.NexefiiAuth.setSession;
  window.NexefiiAuth.hasModuleAccess = window.NexefiiAuth.hasModuleAccess || function () { return true; };
  window.NexefiiAuth.getAllUsers = window.NexefiiAuth.getAllUsers || function () { return []; };
  window.NexefiiAuth.logout = window.NexefiiAuth.logout || function () { window.NexefiiAuth.setSession && window.NexefiiAuth.setSession(null); };
  try { NexefiiAuth = window.NexefiiAuth; NexefiiAuth = window.NexefiiAuth; } catch (e) { }
}
...
if (typeof window !== 'undefined') {
  ...
  try { window.NexefiiAuth = window.NexefiiAuth; } catch(e) {}
}
