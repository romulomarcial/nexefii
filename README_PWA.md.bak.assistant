# 📱 PWA (Progressive Web App) - IluxSys

Transforme IluxSys em um aplicativo instalável com funcionalidade offline completa.
...
1. Acesse `https://iluxsys.com` (ou seu domínio)
2. Veja o banner: **"Instalar IluxSys"**
3. Clique **"Instalar"**
4. Pronto! Ícone na área de trabalho

**Ou manualmente:**
1. Clique no ícone ⊕ na barra de endereço
2. Selecione **"Instalar IluxSys"**
...
```javascript
const CACHE_VERSION = 'iluxsys-v1.0.1'; // ← Incrementar aqui
```
...
- Share target API (compartilhar para IluxSys)
...
> "IluxSys é uma **Progressive Web App** instalável, funcionando como aplicativo nativo em qualquer dispositivo sem necessidade de app stores. Com funcionalidade **offline-first**, hotéis podem operar mesmo com internet instável, sincronizando automaticamente quando a conexão retornar.  
>   
